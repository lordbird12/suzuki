...
*/
  ...
  create(position: any): Observable<any> {
    return this._httpClient.post(environment.API_URL + '/api/quest', position, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getById(positionId: any): Observable<any[]> {
    return this._httpClient.get<any[]>(environment.API_URL + '/api/quest/' + positionId).pipe(
      tap((meterial) => {
        this._materials.next(meterial);
      })
    );
  ...
  update(data: any, id): Observable<any> {
    return this._httpClient.put(environment.API_URL + '/api/quest/' + id, data, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getQuestType(): Observable<any> {
    return this._httpClient.get(environment.API_URL + '/api/quest-type').pipe(
      switchMap((response: any) => {
        return of(response);
      })
    );
  ...
  getQuestSubType(): Observable<any> {
    return this._httpClient.get(environment.API_URL + '/api/quest-sub-type').pipe(
      switchMap((response: any) => {
        return of(response);
      })
    );
  ...
  getQuestGroup(): Observable<any> {
    return this._httpClient.get(environment.API_URL + '/api/quest-group').pipe(
      switchMap((response: any) => {
        return of(response);
      })
    );
  ...
  getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.get(environment.API_URL + '/api/quest/page?page=1&limit=10', dataTablesParameters).pipe(
      switchMap((response: any) => {
        return of(response);
      })
    );
