...
export class Service {
    ...
    create(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/round-time',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    getById(id: any): Observable<any[]> {
        return this._httpClient
            .get<any[]>(environment.API_URL + '/api/round-time/' + id)
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    update(data: any, id): Observable<any> {
        return this._httpClient
            .put(
                environment.API_URL + '/api/round-time/' + id,
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient
            .get(
                environment.API_URL +
                    '/api/round-time/page?page=1&limit=10&filter.classs=$eq:1',
