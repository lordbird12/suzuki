...
import { AssetType, DataPosition, PositionPagination } from '../quest-sub-type.types';
import { Service } from '../quest-sub-type.service';
...
export class ListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    edit(id: string): void {
        this._router.navigate(['quest-sub-type/edit/' + id]);
    }
