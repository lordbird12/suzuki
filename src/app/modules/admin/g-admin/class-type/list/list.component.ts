...
import { AssetType, DataPosition, Pagination } from '../class-type.types';
import { Service } from '../class-type.service';
...
export class ListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    displayedColumns: string[] = ['id', 'name', 'create_by', 'created_at', 'actions'];
    ...
    edit(id: string): void {
        this._router.navigate(['class-type/edit/' + id]);
    }
